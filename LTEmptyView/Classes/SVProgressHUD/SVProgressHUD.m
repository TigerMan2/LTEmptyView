...
+ (void)setShadowColor:(UIColor *)shadowColor {
    [self sharedView].hudView.layer.masksToBounds = NO;
    [self sharedView].hudView.layer.shadowColor = [shadowColor CGColor];
    [self sharedView].hudView.layer.shadowOpacity = 0.8;
    [self sharedView].hudView.layer.shadowOffset = CGSizeMake(0, 3);
    [self sharedView].hudView.layer.shadowRadius = 5;
}

+ (void)setNoShadow {
    [self sharedView].hudView.layer.masksToBounds = YES;
    [self sharedView].hudView.layer.shadowColor = [UIColor clearColor].CGColor;
    [self sharedView].hudView.layer.shadowOpacity = 0;
    [self sharedView].hudView.layer.shadowOffset = CGSizeMake(0, 0);
    [self sharedView].hudView.layer.shadowRadius = 0;
}
